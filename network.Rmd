...
setwd('C:/Users/rmcgibony/Documents')
```
...
download.file("ftp://ftp.fec.gov/FEC/2014/cm14.zip", destfile="cm14.zip")
download.file("ftp://ftp.fec.gov/FEC/2014/cn14.zip", destfile="cn14.zip")
download.file("ftp://ftp.fec.gov/FEC/2014/pas214.zip", destfile="pas214.zip")
